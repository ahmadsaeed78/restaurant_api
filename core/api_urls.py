...
from .views_multorder import create_delivery_order, DeliveryOrderListAPIView, DeliveryOrderRetrieveAPIView, update_delivery_order_status, download_delivery_bill
...
urlpatterns = [
    ...
    # Delivery Order APIs
    path('delivery_orders/', create_delivery_order, name='create_delivery_order'),
    path('api/delivery-orders/', DeliveryOrderListAPIView.as_view(), name='delivery_order_list'),
    path('api/delivery-orders/<int:pk>/', DeliveryOrderRetrieveAPIView.as_view(), name='delivery_order_detail'),
    path('update-delivery-order-status/<int:order_id>/', update_delivery_order_status, name='update_delivery_order_status'),
    path('download-delivery-bill/<int:order_id>/', download_delivery_bill, name='download_delivery_bill'),
]
